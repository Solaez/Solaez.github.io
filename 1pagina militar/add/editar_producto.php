...
$sql = "SELECT * FROM militar WHERE id_producto = $id_producto";
...
if ($result->num_rows > 0) {
    ...
    echo '<form action="/1pagina militar/add/actualizar_producto.php" method="post" enctype="multipart/form-data">';
