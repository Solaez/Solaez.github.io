    ...
    <div class="sidebar-productos">
      <div class="categories-menu">
            ...
            <ul class="submenu">
              ...
              <li>
                ...
                <ul class="submenu">
                  ...
                  <li><a href="#guantes" data-category="guantes" id="guantes">• Guantes</a></li>
              ...
              <li>
                <a href="#Ropa" data-category="all">Ropa ▾</a>
                <ul class="submenu">
                  ...
                  <li><a href="#conjuntos" data-category="conjuntos" id="conjuntos">• Conjuntos</a></li>
                  ...
                  <li><a href="#Tennis" data-category="tennis" id="tennis">• Botas</a></li>
                </ul>
              </li>
              ...
              <li><a href="#Insignias-Parches" data-category="insignias" id="insignias">Insignias y Parches</a></li>

              <li><a href="#carpas" data-category="carpas" id="carpas">Carpas</a></li>
              <li><a href="#chalecos" data-category="chalecos" id="chalecos">Chalecos</a></li>
              <li><a href="#kit" data-category="kit" id="kit">KIT</a></li>
              <li><a href="#entretenimiento" data-category="entretenimiento" id="entretenimiento">Entretenimiento</a></li>
        ...
        <ul class="subpc">
          ...
          <li><a href="#banderas" data-category="banderas" id="banderas">Banderas</a></li>
