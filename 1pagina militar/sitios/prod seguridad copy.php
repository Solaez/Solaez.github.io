...
<header class="header1">
  <div class="header-container">
      <a href="/index.php" class="logo">
          <img src="/1pagina militar/img/iconos/LOGO hd.png" alt="Logo">
      </a>
      <nav>
          <ul class="nav-links">
              <li><a href="/1pagina militar/sitios/inicio.php">Inicio</a></li>
              <li class="dropdown">
                <a href="/1pagina militar/sitios/prod.php#Productos">Productos▾</a>
                <div class="dropdown-content">

                  <a href="/1pagina militar/sitios/prod.php#acesorio">Acesorios</a>
                    <!-- Agregar el nuevo dropdown de camisas -->
                    <div class="dropdown-camisas">
                        <a href="/1pagina militar/sitios/prod.php#camisas">Ropa▾</a>
                        <div class="dropdown-camisas-content">
                            <a href="/1pagina militar/sitios/prod.php#camibuso" >Camibusos</a>
                            <a href="/1pagina militar/sitios/prod.php#camisas" >Camisas</a>
                            <a href="/1pagina militar/sitios/prod.php#pantalone">pantalones</a>
                        </div>
                    </div>
                    <a href="/1pagina militar/sitios/prod.php#bolsos">Bolsos</a>
                    <!-- Agregar el nuevo dropdown de estampados -->
                    <div class="dropdown-camisas">
                      <a href="/1pagina militar/sitios/prod.php#estampados">Estampados▾</a>
                      <div class="dropdown-estampados-content">
                          <a href="/1pagina militar/sitios/prod.php#estampados">Estampados</a>
                          <a href="/1pagina militar/sitios/prod.php#personalizado">Personalizados</a>
                      </div>
                  </div>
                  <!-- Agregar el nuevo dropdown de gorras -->
                  <div class="dropdown-camisas">
                    <a href="/1pagina militar/sitios/prod.php#gorra">Gorras▾</a>
                    <div class="dropdown-gorras-content">
                        <a href="/1pagina militar/sitios/prod.php#boina">Boinas</a>
                        <a href="/1pagina militar/sitios/prod.php#gorra">Gorras</a>
                        <a href="/1pagina militar/sitios/prod.php#pava">Pavas</a>
                        <a href="/1pagina militar/sitios/prod.php#cascos">casco</a>
                    </div>
                  </div>
                  <!-- Agregar el nuevo dropdown de banderas -->
                  <div class="dropdown-camisas">
                    <a href="/1pagina militar/sitios/prod.php#exteriore">Banderas▾</a>
                    <div class="dropdown-banderas-content">
                        <a href="/1pagina militar/sitios/prod.php#exteriore">Banderas exteriores</a>
                        <a href="/1pagina militar/sitios/prod.php#interiore">Banderas interiores</a>
                        <a href="/1pagina militar/sitios/prod.php#banderine">Banderines</a>
                    </div>
                  </div>
                  <!-- Agregar el nuevo dropdown de Seguridad▾ -->
                  <div class="dropdown-camisas">
                    <a href="/1pagina militar/sitios/prod.php#ejercito">Seguridad▾</a>
                    <div class="dropdown-seguridad-content">
                        <a href="/1pagina militar/sitios/prod.php#ejercito">Ejercito y Policía</a>
                        <a href="/1pagina militar/sitios/prod.php#rescate">Personal de Rescate</a>
                        <a href="/1pagina militar/sitios/prod.php#privada">Seguridad Privada</a>
                        <a href="/1pagina militar/sitios/prod.php#vial">Seguridad Vial</a>
                    </div>
                  </div>
                    <a href="/1pagina militar/sitios/prod.php#insignia">Insigias y Parches</a>
                    <a href="/1pagina militar/sitios/prod.php#promocion">Ofertas</a>
                </div>
              </li>
              <li><a href="/1pagina militar/sitios/ubic.php">Ubicación</a></li>
              <li><a href="/1pagina militar/sitios/cont.php">Contacto </a></li>
              <li><a href="/1pagina militar/sitios/acer.php">Acerca de</a></li>
          </ul>
          ...
          <main>
            ...
            <div id="product-grid">
                ...
                <div id="CB003" class="product" data-category="ropa,camibuso">
                  ...
                  <a href="#CB003"><button class="scrollToTop">Seleccionar</button></a>
                  <div id="product-details"  style="display: none;">
                ...
                <div id="B001" class="product" data-category="ropa,busos">
                  ...
                  <a href="#B001"><button class="scrollToTop">Seleccionar</button></a>
                  <div id="product-details"  style="display: none;">
                ...
                <div id="C001" class="product" data-category="gorras,casco">
                  ...
                  <a href="#C001"><button class="scrollToTop">Seleccionar</button></a>
                  <div id="product-details"  style="display: none;">
                ...
                <div id="BD002" class="product" data-category="bordados,estampados">
                  ...
                  <a href="#BD002"><button class="scrollToTop">Seleccionar</button></a>
                  <div id="product-details"  style="display: none;">
...
<nav>
  <div class="institutos">
    <div class="institutos-track">
      <!-- Duplica el contenido del carrusel -->
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (1).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (2).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (3).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (4).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (5).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (6).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (7).png" height="100" width="250" alt="" />
      </div>
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (8).png" height="100" width="250" alt="" />
      </div>
      <!-- Fin de la duplicación -->
      <!-- Duplica el contenido del carrusel -->
      <div class="instituto">
        <img src="/1pagina militar/img/imagenes/instituciones/marca (1).png" height="100" width="250" alt="" />
      </div>
